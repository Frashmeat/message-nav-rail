...
1. 从 [`v17.0.6-custom.1` Release](https://github.com/Frashmeat/message-nav-rail/releases/tag/v17.0.6-custom.1) 下载 `message-nav-rail-omp-17.0.6-custom.1-windows-x64.zip` 和对应的 `.zip.sha256` 文件。
