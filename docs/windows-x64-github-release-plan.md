...
- 构建 Action [`29829441666`](https://github.com/Frashmeat/message-nav-rail/actions/runs/29829441666) 已成功，源码提交为 `dab8e99213330fa3a2b15dbf66be5294ccf4eeb2`。
- [`v17.0.6-custom.1`](https://github.com/Frashmeat/message-nav-rail/releases/tag/v17.0.6-custom.1) 已发布为 prerelease。
- Release 资产为 `message-nav-rail-omp-17.0.6-custom.1-windows-x64.zip` 及对应 `.zip.sha256`。
- 发布 ZIP 的 SHA-256 为 `d5ddc67977494a65d634e439f7fe5227a583ef143d5117d42d58cd173eae1b12`。
- 当前 prerelease 已完成构建、打包、内嵌 native 探测和静态完整性验收；独立 Windows 10/11 目标机的安装、升级与故障回滚验收仍待执行。
...
- Action run [`29829441666`](https://github.com/Frashmeat/message-nav-rail/actions/runs/29829441666) 已完成 native、`omp.exe`、扩展、baseline/modern 内嵌 native 探测和 Release 打包。
- `v17.0.6-custom.1` 已发布；本机尚未覆盖安装该版本，安装版本仍需通过 `omp.exe --version` 实时确认。
...
```text
message-nav-rail-omp-17.0.6-custom.1-windows-x64.zip
├─ omp.exe
├─ extension/
...
2026-07-21，run `29829441666` 已完成 `17.0.6-custom.1` 的成功构建和 Artifact 校验。prerelease 由人工确认产物后使用 GitHub CLI 创建，自动创建 Release 的工作流仍未实现。
